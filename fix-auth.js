...
const file = 'client/src/pages/AuthPage.tsx';
...
content = content.replace(/liquid-glass-cyan/g, 'bg-[#111111] text-white hover:bg-[#333333] shadow-[0_8px_30px_rgba(0,0,0,0.12)]');
